                    ...
                    <div class="col-md-12">
                     ...
                     <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="textarea" class="form-control @error('isi_pengumuman') is-invalid @enderror" id="isi_pengumuman" placeholder="masukan isi pengumuman" name="isi_pengumuman" value="{{ old('isi_pengumuman') }}" required>
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        $.post("{{ route('pengumuman.destroy', ':id') }}".replace(':id', id), {'_method' : 'DELETE'},function(data){
