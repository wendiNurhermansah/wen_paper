                    ...
                    <div class="col-md-12">
                     ...
                     <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="textarea" class="form-control @error('isi_sambutan') is-invalid @enderror" id="isi_sambutan" placeholder="masukan isi_sambutan" name="isi_sambutan" value="{{ old('isi_sambutan') }}" required>
                            @error('isi_sambutan')
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        order: [0, 'asc'],
        ajax: {
            url: "{{ route('sambutan.api')}}",
            method: 'POST'
        },
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false, align: 'center', className: 'text-center'},
            {data: 'isi_sambutan', name: 'isi_sambutan'},
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        $.post("{{ route('sambutan.destroy', ':id') }}".replace(':id', id), {'_method' : 'DELETE'},function(data){
