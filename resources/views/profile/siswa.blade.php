                    ...
                    <div class="col-md-12">
                     ...
                     <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="textarea" class="form-control @error('nama_siswa') is-invalid @enderror" id="nama_siswa" placeholder="masukan nama siswa" name="nama_siswa" value="{{ old('nama_siswa') }}" required>
                            @error('nama_siswa')
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        $.post("{{ route('daftarsiswa.destroy', ':id') }}".replace(':id', id), {'_method' : 'DELETE'},function(data){
