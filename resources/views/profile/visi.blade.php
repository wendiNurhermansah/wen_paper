                    ...
                    <div class="col-md-12">
                     ...
                     <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            <label for="visi_m">isi Sambutan</label>
                            <input type="textarea" class="form-control @error('visi_m') is-invalid @enderror" id="visi_m" placeholder="masukan visi & misi" name="visi_m" value="{{ old('visi_m') }}" required>
                            @error('visi_m')
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        $.post("{{ route('visi.destroy', ':id') }}".replace(':id', id), {'_method' : 'DELETE'},function(data){
