                ...
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            <label for="isi_prestasi">Isi Prestasi</label>
                            <input type="textarea" class="form-control @error('isi_prestasi') is-invalid @enderror" id="isi_prestasi" placeholder="masukan isi prestasi" name="isi_prestasi" value="{{ old('isi_prestasi') }}" required>
                            @error('isi_prestasi')
                                <div class="valid-feedback">
                                    {{ $message }}
                                </div>
...
<script type="text/javascript">
     var table = $('#dataTable').dataTable({
        ...
        order: [0, 'asc'],
        ajax: {
            url: "{{ route('prestasi.api')}}",
            method: 'POST'
        },
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false, align: 'center', className: 'text-center'},
            {data: 'n_prestasi', name: 'n_prestasi'},
            {data: 'isi_prestasi', name: 'isi_prestasi'},
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        $.post("{{ route('prestasi.destroy', ':id') }}".replace(':id', id), {'_method' : 'DELETE'},function(data){
